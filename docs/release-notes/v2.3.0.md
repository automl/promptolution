...
* Added `accelerate` as a dependency of the `[transformers]` extra, enabling local inference on Mac (MPS) and other devices without manual installation
...
**Full Changelog**: [here](https://github.com/automl/promptolution/compare/v2.2.2...v2.3.0)
